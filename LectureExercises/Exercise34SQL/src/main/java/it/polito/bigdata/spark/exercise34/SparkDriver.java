...
import it.polito.bigdata.spark.exercise34.Reading;
...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		Dataset<Reading> selectedReadings = 
				ss.sql("SELECT _c0, _c1, _c2 FROM readings WHERE _c2="+maxValue).as(Encoders.bean(Reading.class));
